...
//Page_BeforeInitialize @1-EE0C2AAF
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_user_role_form; //Compatibility
...
//Page_AfterInitialize @1-21F9146D
