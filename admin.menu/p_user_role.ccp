		...
		<Panel id="3" visible="True" generateDiv="True" name="Content" contentPlaceholder="Content" PathID="Content">
			<Components>
				<Panel id="4" visible="True" generateDiv="False" name="Panel1" PathID="ContentPanel1" features="(assigned)">
					<Components>
						<Grid id="6" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" name="roleGrid" connection="hrcon" dataSource="SELECT a.*, b.code
...
OR upper(a.description) LIKE upper('%%')
							...
							<Components>
								...
								<ImageLink id="11" visible="Yes" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="editlink" PathID="ContentPanel1roleGrideditlink" hrefSource="p_user_role_form.ccp" linkProperties="{'textSource':' ','textSourceDB':'','hrefSource':'p_user_role_form.ccp','hrefSourceDB':'','title':'','target':'','name':'','linkParameters':{'0':{'sourceType':'DataField','parameterSource':'p_role_id','parameterName':'p_role_id'},'1':{'sourceType':'DataField','parameterSource':'p_role_module_id','parameterName':'p_role_module_id'},'2':{'sourceType':'DataField','parameterSource':'p_role_module_id','parameterName':'p_role_module_id'},'3':{'sourceType':'DataField','parameterSource':'p_role_module_id','parameterName':'p_role_module_id'},'4':{'sourceType':'DataField','parameterSource':'p_user_attribute_id','parameterName':'p_user_attribute_id'},'5':{'sourceType':'DataField','parameterSource':'p_user_role_id','parameterName':'p_user_role_id'},'6':{'sourceType':'DataField','parameterSource':'p_user_role_id','parameterName':'p_user_role_id'},'7':{'sourceType':'DataField','parameterSource':'p_user_role_id','parameterName':'p_user_role_id'},'8':{'sourceType':'DataField','parameterSource':'p_user_role_id','parameterName':'p_user_role_id'},'length':9,'objectType':'linkParameters'}}">
									<Components/>
									<Events/>
									<LinkParameters>
										<LinkParameter id="63" sourceType="DataField" name="p_user_role_id" source="p_user_role_id"/>
</LinkParameters>
									<Attributes/>
									<Features/>
								</ImageLink>
								<ImageLink id="13" visible="Yes" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="addlink" PathID="ContentPanel1roleGridaddlink" linkProperties="{'textSource':'../images/AddNew.gif','textSourceDB':'','hrefSource':'p_user_role_form.ccp','hrefSourceDB':'','title':'','target':'','name':'','linkParameters':{'0':{'sourceType':'DataField','parameterSource':'p_user_id','parameterName':'p_user_id'},'1':{'sourceType':'DataField','parameterSource':'p_user_id','parameterName':'p_user_id'},'length':2,'objectType':'linkParameters'}}" hrefSource="p_user_role_form.ccp" removeParameters="p_user_role_id">
									<Components/>
									<Events/>
									<LinkParameters>
								...
								<Label id="14" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="code" fieldSource="code" wizardCaption="Code" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="ContentPanel1roleGridcode">
									<Components/>
									<Events/>
									<Attributes/>
									<Features/>
							...
							<SPParameters/>
							<SQLParameters>
								<SQLParameter id="61" dataType="Float" defaultValue="0" parameterSource="p_user_id" parameterType="URL" variable="p_user_id"/>
<SQLParameter id="62" dataType="Text" parameterSource="s_keyword" parameterType="URL" variable="s_keyword"/>
</SQLParameters>
							<SecurityGroups/>
							<Attributes/>
							<Features/>
						</Grid>
						<Link id="36" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="ContentPanel1Link1" hrefSource="p_user.ccp" wizardUseTemplateBlock="False" linkProperties="{'textSource':'User','textSourceDB':'','hrefSource':'p_user.ccp','hrefSourceDB':'','title':'','target':'','name':'','linkParameters':{'length':0,'objectType':'linkParameters'}}" removeParameters="p_role_id;s_keyword">
<Components/>
							<Events/>
							<LinkParameters/>
							<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_user_role_events.php" forShow="False" comment="//" codePage="windows-1252"/>
