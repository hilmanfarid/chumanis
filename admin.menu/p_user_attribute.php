<?php
//Include Common Files @1-B240E858
define("RelativePath", "..");
define("PathToCurrentPage", "/admin.menu/");
define("FileName", "p_user_attribute.php");
...
//Class_Initialize Event @6-EACE258B
    function clsGridroleGrid($RelativePath, & $Parent)
    {
        ...
        $this->user_attribute_value = new clsControl(ccsLabel, "user_attribute_value", "user_attribute_value", ccsText, "", CCGetRequestParam("user_attribute_value", ccsGet, NULL), $this);
        $this->editlink = new clsControl(ccsImageLink, "editlink", "editlink", ccsText, "", CCGetRequestParam("editlink", ccsGet, NULL), $this);
        $this->editlink->Page = "p_user_attribute_form.php";
        $this->attribut_type = new clsControl(ccsLabel, "attribut_type", "attribut_type", ccsText, "", CCGetRequestParam("attribut_type", ccsGet, NULL), $this);
        ...
        $this->addlink->Page = "p_user_attribute_form.php";
    }
...
//Show Method @6-54E15266
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            $this->ControlsVisible["user_attribute_value"] = $this->user_attribute_value->Visible;
            $this->ControlsVisible["editlink"] = $this->editlink->Visible;
            $this->ControlsVisible["attribut_type"] = $this->attribut_type->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->editlink->Parameters = CCAddParam($this->editlink->Parameters, "p_user_attribute_id", $this->DataSource->f("p_user_attribute_id"));
        ...
        $this->addlink->Parameters = CCGetQueryString("QueryString", array("p_user_attribute_id", "ccsForm"));
...
//GetErrors Method @6-C73B04EE
    function GetErrors()
    {
        $errors = "";
        $errors = ComposeStrings($errors, $this->user_attribute_value->Errors->ToString());
        $errors = ComposeStrings($errors, $this->editlink->Errors->ToString());
        $errors = ComposeStrings($errors, $this->attribut_type->Errors->ToString());
...
//DataSource Variables @6-D7D1EB87
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-634DFC76
...
//Open Method @6-60746918
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT a.*, b.code AS attribut_type\n" .
        "FROM p_user_attribute AS a\n" .
        "LEFT JOIN p_user_attribute_type AS b ON a.p_user_attribute_type_id = b.p_user_attribute_type_id\n" .
        "WHERE a.p_user_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "AND (\n" .
        "upper(a.user_attribute_value) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("2"), ccsText) . "%') \n" .
        "OR upper(a.description) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("2"), ccsText) . "%')\n" .
        ")) cnt";
        $this->SQL = "SELECT a.*, b.code AS attribut_type\n" .
        "FROM p_user_attribute AS a\n" .
        "LEFT JOIN p_user_attribute_type AS b ON a.p_user_attribute_type_id = b.p_user_attribute_type_id\n" .
        "WHERE a.p_user_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "AND (\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_user_attribute.html";
$BlockToParse = "main";
...
//Include events file @1-6E8F0D44
include_once("./p_user_attribute_events.php");
...
$Link1->Parameters = CCGetQueryString("QueryString", array("p_user_attribute_id", "s_keyword", "ccsForm"));
