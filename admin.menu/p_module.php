<?php
//Include Common Files @1-76F06E99
define("RelativePath", "..");
define("PathToCurrentPage", "/admin.menu/");
define("FileName", "p_module.php");
...
//Class_Initialize Event @6-F4C42DBF
    function clsGridroleGrid($RelativePath, & $Parent)
    {
        ...
        $this->editlink->Page = "p_module_form.php";
        ...
        $this->addlink->Parameters = CCGetQueryString("QueryString", array("p_module_id", "ccsForm"));
        $this->addlink->Page = "p_module_form.php";
    }
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->editlink->Parameters = CCAddParam($this->editlink->Parameters, "p_module_id", $this->DataSource->f("p_module_id"));
                $this->description->SetValue($this->DataSource->description->GetValue());
                $this->code->SetValue($this->DataSource->code->GetValue());
                $this->Link2->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                $this->Link2->Parameters = CCAddParam($this->Link2->Parameters, "p_module_id", $this->DataSource->f('p_module_id'));
                $this->Link3->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                $this->Link3->Parameters = CCAddParam($this->Link3->Parameters, "p_module_id", $this->DataSource->f('p_module_id'));
...
//DataSource Variables @6-9C6FF419
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-FC26BBC0
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_module.html";
$BlockToParse = "main";
...
//Include events file @1-A7886921
include_once("./p_module_events.php");
