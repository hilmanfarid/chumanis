<?php
//Include Common Files @1-345D04D9
define("RelativePath", "..");
define("PathToCurrentPage", "/admin.menu/");
define("FileName", "p_role_menu_form.php");
...
class clsRecordroleMenuForm { //roleMenuForm Class @4-46D012FD
...
//Class_Initialize Event @4-25D2DFFD
    function clsRecordroleMenuForm($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record roleMenuForm/Error";
        $this->DataSource = new clsroleMenuFormDataSource($this);
        ...
        if($this->Visible)
        {
            $this->ComponentName = "roleMenuForm";
            ...
            $this->p_role_menu_id = new clsControl(ccsHidden, "p_role_menu_id", "p_role_menu_id", ccsFloat, "", CCGetRequestParam("p_role_menu_id", $Method, NULL), $this);
            ...
            $this->DatePicker_valid_from1 = new clsDatePicker("DatePicker_valid_from1", "roleMenuForm", "valid_from", $this);
            ...
            $this->DatePicker_valid_from2 = new clsDatePicker("DatePicker_valid_from2", "roleMenuForm", "valid_from", $this);
            $this->DatePicker_valid_to1 = new clsDatePicker("DatePicker_valid_to1", "roleMenuForm", "valid_to", $this);
...
//Initialize Method @4-13643916
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlp_role_menu_id"] = CCGetFromGet("p_role_menu_id", NULL);
    }
//End Initialize Method

//Validate Method @4-C19ADA43
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        ...
        $Validation = ($this->p_role_menu_id->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->p_role_menu_id->Errors->Count() == 0);
...
//CheckErrors Method @4-54EB5131
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->p_role_menu_id->Errors->Count());
...
//Operation Method @4-C0E4DF10
    function Operation()
    {
        ...
        $Redirect = "p_role_menu.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "ccsForm", "p_role_menu_id"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "p_role_menu.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "ccsForm", "p_role_menu_id", "p_role_id"));
...
//Show Method @4-C039D499
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->p_role_menu_id->Errors->ToString());
...
} //End roleMenuForm Class @4-FCB6E20C

class clsroleMenuFormDataSource extends clsDBhrcon {  //roleMenuFormDataSource Class @4-9F74F9F2

//DataSource Variables @4-FF068E8C
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @4-4B9A1009
    function clsroleMenuFormDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record roleMenuForm/Error";
        $this->Initialize();
        ...
        $this->InsertFields["p_menu_id"] = array("Name" => "p_menu_id", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
...
//Prepare Method @4-544B62F1
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlp_role_menu_id", ccsFloat, "", "", $this->Parameters["urlp_role_menu_id"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "p_role_menu_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsFloat),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @4-DCBB03A4
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT p_role_menu.*, code AS role_name \n\n" .
        "FROM p_role_menu INNER JOIN p_role ON\n\n" .
...
//Insert Method @4-8F072BCA
    function Insert()
    {
        ...
        $this->cp["p_menu_id"] = new clsSQLParameter("ctrlp_menu_id", ccsFloat, "", "", $this->p_menu_id->GetValue(true), NULL, false, $this->ErrorBlock);
        ...
        $this->InsertFields["p_menu_id"]["Value"] = $this->cp["p_menu_id"]->GetDBValue(true);
        ...
        $this->SQL = CCBuildInsert("p_role_menu", $this->InsertFields, $this);
...
//Update Method @4-D602EAF0
    function Update()
    {
        ...
        $wp->AddParameter("1", "urlp_role_menu_id", ccsFloat, "", "", CCGetFromGet("p_role_menu_id", NULL), "", false);
        if(!$wp->AllParamsSet()) {
        ...
        if (!is_null($this->cp["valid_to"]->GetValue()) and !strlen($this->cp["valid_to"]->GetText()) and !is_bool($this->cp["valid_to"]->GetValue())) 
            $this->cp["valid_to"]->SetValue($this->valid_to->GetValue(true));
        $wp->Criterion[1] = $wp->Operation(opEqual, "p_role_menu_id", $wp->GetDBValue("1"), $this->ToSQL($wp->GetDBValue("1"), ccsFloat),false);
        $Where = 
             $wp->Criterion[1];
        ...
        $this->SQL = CCBuildUpdate("p_role_menu", $this->UpdateFields, $this);
...
//Delete Method @4-4112647D
    function Delete()
    {
        ...
        $Where = 
             $wp->Criterion[1];
        $this->SQL = "DELETE FROM p_role_menu";
...
} //End roleMenuFormDataSource Class @4-FCB6E20C

//Include Page implementation @120-41C3001C
include_once(RelativePath . "/Designs/modal/modal_start.php");
//End Include Page implementation

//Include Page implementation @123-49C15BEE
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_role_menu_form.html";
$BlockToParse = "main";
...
//Include events file @1-7C39BA6C
include_once("./p_role_menu_form_events.php");
...
$roleMenuForm = new clsRecordroleMenuForm("", $MainPage);
...
$MainPage->roleMenuForm = & $roleMenuForm;
...
$Content->AddComponent("roleMenuForm", $roleMenuForm);
...
//Execute Components @1-05CFE81B
$MasterPage->Operations();
$modal_end->Operations();
$modal_start->Operations();
$roleMenuForm->Operation();
//End Execute Components

//Go to destination page @1-3A903B77
if($Redirect)
{
