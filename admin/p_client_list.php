<?php
//Include Common Files @1-B8EF6964
define("RelativePath", "..");
define("PathToCurrentPage", "/admin/");
define("FileName", "p_client_list.php");
...
class clsGridp_client { //p_client class @9-9823B84A
...
//Class_Initialize Event @9-E034D2FB
    function clsGridp_client($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->p_client_id->Page = "p_client_list.php";
        ...
        $this->p_client_id_edit = new clsControl(ccsImageLink, "p_client_id_edit", "p_client_id_edit", ccsFloat, "", CCGetRequestParam("p_client_id_edit", ccsGet, NULL), $this);
        $this->p_client_id_edit->Page = "p_client_main.php";
        $this->p_client_TotalRecords = new clsControl(ccsLabel, "p_client_TotalRecords", "p_client_TotalRecords", ccsText, "", CCGetRequestParam("p_client_TotalRecords", ccsGet, NULL), $this);
        ...
        $this->ImageLink1->Page = "p_client_main.php";
    }
...
//Show Method @9-B9685595
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["p_client_id_edit"] = $this->p_client_id_edit->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->p_client_id_edit->SetValue($this->DataSource->p_client_id_edit->GetValue());
                $this->p_client_id_edit->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                $this->p_client_id_edit->Parameters = CCAddParam($this->p_client_id_edit->Parameters, "p_client_id", $this->DataSource->f("p_client_id"));
        ...
        $this->p_client_TotalRecords->Show();
        $this->Navigator->Show();
...
//GetErrors Method @9-95D459A1
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->p_client_id_edit->Errors->ToString());
...
} //End p_client Class @9-FCB6E20C

class clsp_clientDataSource extends clsDBhrcon {  //p_clientDataSource Class @9-7A65C0B5

//DataSource Variables @9-00705FC1
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $updated_date;
    public $updated_by;
    public $p_client_id_edit;
//End DataSource Variables

//DataSourceClass_Initialize Event @9-A2BFD998
    function clsp_clientDataSource(& $Parent)
    {
        ...
        $this->p_client_id_edit = new clsField("p_client_id_edit", ccsFloat, "");
...
//SetValues Method @9-A43D5417
    function SetValues()
    {
        ...
        $this->p_client_id_edit->SetDBValue(trim($this->f("p_client_id")));
    }
//End SetValues Method

} //End p_clientDataSource Class @9-FCB6E20C

class clsRecordp_clientSearch { //p_clientSearch Class @22-9395DD9A
...
//Class_Initialize Event @22-B9AC9626
...
//CheckErrors Method @22-E7FCDD64
...
//Operation Method @22-DD3A255D
    function Operation()
    {
        ...
        $Redirect = "p_client_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_client_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End p_clientSearch Class @22-FCB6E20C

class clsEditableGridp_company_client { //p_company_client Class @30-43DD3E75

//Variables @30-0AADA924
...
//Class_Initialize Event @30-DA89D902
    function clsEditableGridp_company_client($RelativePath, & $Parent)
    {
        ...
        $this->creation_date = new clsControl(ccsTextBox, "creation_date", $CCSLocales->GetText("creation_date"), ccsDate, array("dd", "/", "mm", "/", "yyyy"), NULL, $this);
        ...
        $this->updated_date = new clsControl(ccsTextBox, "updated_date", $CCSLocales->GetText("updated_date"), ccsDate, array("dd", "/", "mm", "/", "yyyy"), NULL, $this);
...
//GetFormParameters Method @30-A28466E5
...
//ValidateRow Method @30-8790B823
...
//CheckInsert Method @30-58F2E0C4
...
//CheckErrors Method @30-F5A3B433
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->Errors->Count());
...
//FormScript Method @30-8738A429
    function FormScript($TotalRows)
    {
        $script = "";
        $script .= "\n<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n";
        $script .= "var p_company_clientElements;\n";
        $script .= "var p_company_clientEmptyRows = 1;\n";
        $script .= "var " . $this->ComponentName . "codeID = 0;\n";
        $script .= "var " . $this->ComponentName . "company_nameID = 1;\n";
        $script .= "var " . $this->ComponentName . "descriptionID = 2;\n";
        $script .= "var " . $this->ComponentName . "creation_dateID = 3;\n";
        $script .= "var " . $this->ComponentName . "created_byID = 4;\n";
        $script .= "var " . $this->ComponentName . "updated_dateID = 5;\n";
        $script .= "var " . $this->ComponentName . "updated_byID = 6;\n";
        $script .= "var " . $this->ComponentName . "DeleteControl = 7;\n";
        $script .= "\nfunction initp_company_clientElements() {\n";
        $script .= "\tvar ED = document.forms[\"p_company_client\"];\n";
        $script .= "\tp_company_clientElements = new Array (\n";
        for($i = 1; $i <= $TotalRows; $i++) {
            $script .= "\t\tnew Array(" . "ED.code_" . $i . ", " . "ED.company_name_" . $i . ", " . "ED.description_" . $i . ", " . "ED.creation_date_" . $i . ", " . "ED.created_by_" . $i . ", " . "ED.updated_date_" . $i . ", " . "ED.updated_by_" . $i . ", " . "ED.CheckBox_Delete_" . $i . ")";
...
//SetFormState Method @30-69E01441
...
//GetFormState Method @30-BF9CEBD0
...
} //End p_company_client Class @30-FCB6E20C

class clsp_company_clientDataSource extends clsDBhrcon {  //p_company_clientDataSource Class @30-A4E4C26C

//DataSource Variables @30-137E3651
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @30-59F10081
...
//Insert Method @30-9BD2BC69
    function Insert()
    {
        ...
        $this->cp["creation_date"] = new clsSQLParameter("ctrlcreation_date", ccsDate, array("dd", "/", "mm", "/", "yyyy"), $this->DateFormat, $this->creation_date->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["created_by"] = new clsSQLParameter("ctrlcreated_by", ccsText, "", "", $this->created_by->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["updated_date"] = new clsSQLParameter("ctrlupdated_date", ccsDate, array("dd", "/", "mm", "/", "yyyy"), $this->DateFormat, $this->updated_date->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["updated_by"] = new clsSQLParameter("ctrlupdated_by", ccsText, "", "", $this->updated_by->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["p_client_id"] = new clsSQLParameter("urlp_client_id", ccsInteger, "", "", CCGetFromGet("p_client_id", NULL), -1, false, $this->ErrorBlock);
        ...
        if (!strlen($this->cp["p_client_id"]->GetText()) and !is_bool($this->cp["p_client_id"]->GetValue(true))) 
            $this->cp["p_client_id"]->SetText(-1);
        ...
        " " . $this->SQLValue($this->cp["p_client_id"]->GetDBValue(), ccsInteger) . ",\n" .
        " '" . $this->SQLValue($this->cp["code"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["company_name"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["description"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["creation_date"]->GetDBValue(), ccsDate) . "', '" . $this->SQLValue($this->cp["created_by"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["updated_date"]->GetDBValue(), ccsDate) . "', '" . $this->SQLValue($this->cp["updated_by"]->GetDBValue(), ccsText) . "')";
...
} //End p_company_clientDataSource Class @30-FCB6E20C

//Include Page implementation @80-38AA8992
//include_once(RelativePath . "/admin/./vmenu.php");
//End Include Page implementation

//Initialize Page @1-A07EF8C8
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_client_list.html";
$BlockToParse = "main";
...
//Include events file @1-97DBBB7D
include_once("./p_client_list_events.php");
...
$p_client = new clsGridp_client("", $MainPage);
...
$TemplatePanel2->MasterPageInitialize("VerticalMenu", "/Designs/" . $CCProjectDesign . "/", "VerticalMenu.html");
...
$vmenu = new clsvmenu("./", "vmenu", $MainPage);
$vmenu->Initialize();
...
$MainPage->vmenu = & $vmenu;
$MainPage->HeaderSidebar = & $HeaderSidebar;
$Content->AddComponent("Panel1", $Panel1);
$Content->AddComponent("Panel2", $Panel2);
$Panel1->AddComponent("p_client", $p_client);
$Panel1->AddComponent("p_clientSearch", $p_clientSearch);
$Panel2->AddComponent("p_company_client", $p_company_client);
...
$MenuItems2->AddComponent("vmenu", $vmenu);
$p_client->Initialize();
...
//Go to destination page @1-893B70BC
if($Redirect)
{
