...
class clsMasterBlank { //MasterBlank class @1-CD7500BE
...
//Class_Initialize Event @1-27030FDB
    function clsMasterBlank($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "MasterBlank.php";
        $this->Redirect = "";
        $this->TemplateFileName = "MasterBlank.html";
...
//Initialize Method @1-5F69229E
    function Initialize($Path = "")
    {
        ...
        // Create Components
        $this->content_blank = new clsPanel("content_blank", $this);
        $this->content_blank->isContentPlaceholder = true;
        $this->BindEvents();
...
} //End MasterBlank Class @1-FCB6E20C
?>
