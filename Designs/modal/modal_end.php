<?php
class clsmodal_end { //modal_end class @1-F02D2404
...
//Class_Initialize Event @1-D8CEB83C
    function clsmodal_end($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "modal_end.php";
        $this->Redirect = "";
        $this->TemplateFileName = "modal_end.html";
...
} //End modal_end Class @1-FCB6E20C
